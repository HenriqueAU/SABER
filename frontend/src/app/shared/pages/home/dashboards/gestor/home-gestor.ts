...
interface DashboardGestor {
  ...
  generosPorFaixa: { faixa: string; generos: { nome: string; total: number }[] };
...
export default class HomeGestorComponent implements OnInit {
  dashboard = signal<DashboardGestor | null>(null);
  ...
  private getMockData(): DashboardGestor {
    return {
      totalUsuarios: 248,
      totalLivros: 512,
      ...
      generosPorFaixa: { faixa: 'todas', generos: [] },
    };
  }
}
