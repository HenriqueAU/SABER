...
export class ClubeService {
  ...
  async findAll(): Promise<ClubeLivro[]> {
    return await this.clubeLivroRepository.find({ relations: ['professor', 'livro'] });
  }
  ...
  async update(id: string, updateClubeLivroDto: UpdateClubeLivroDto): Promise<ClubeLivro> {
