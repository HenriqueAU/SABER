...
export class MigrationInicial1780765180937 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "resposta_membro" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "membro_id" uuid, "item_pergunta_id" uuid, CONSTRAINT "PK_b83e8b6a98e57cfef1e2d47c9e2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "resposta_membro" ADD CONSTRAINT "FK_acd7bed92e0471bf1ec283424d5" FOREIGN KEY ("membro_id") REFERENCES "membro_clube"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "resposta_membro" DROP CONSTRAINT "FK_acd7bed92e0471bf1ec283424d5"`);
